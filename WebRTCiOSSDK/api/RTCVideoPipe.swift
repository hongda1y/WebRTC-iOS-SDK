...
@objc public class RTCVideoPipe: NSObject, RTCVideoCapturerDelegate {
    ...
    private static func isFrontCamera(_ capturer: RTCVideoCapturer) -> Bool {
        guard let camera = capturer as? CustomCameraVideoCapturer else { return false }
    ...
    private func emitFrame(_ frame: RTCVideoFrame,
                           from capturer: RTCVideoCapturer,
